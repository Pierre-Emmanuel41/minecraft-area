...
public enum EAreaMessageCode implements IMinecraftMessageCode {
	...
	LAUNCH_AREA__EXPLANATION, LAUNCH_AREA__NO_CURRENT_AREA, LAUNCH_AREA__WORLD_IS_MISSING, LAUNCH_AREA__AREA_DOES_NOT_EXIST, LAUNCH_AREA__AREA_LAUNCHED,

	// Code for command details
	DETAILS_AREA__EXPLANATION, DETAILS_AREA__ON_DETAILS;
